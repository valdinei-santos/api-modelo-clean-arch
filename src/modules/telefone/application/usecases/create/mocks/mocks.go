...
// Source: src/modules/telefone/application/usecases/create/interfaces.go
//
...
func (m *MockIUsecase) Execute(t *dto.Request) (*dto.OutputDefault, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Execute", t)
...
func (mr *MockIUsecaseMockRecorder) Execute(t any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Execute", reflect.TypeOf((*MockIUsecase)(nil).Execute), t)
}
