...
// Source: src/modules/cliente/application/get/usecase/interfaces.go
//
...
func (m *MockIUsecase) Execute(stamp, cpf string) (*dto.Response, error) {
	m.ctrl.T.Helper()
...
// FindByIdTelefone mocks base method.
func (m *MockIRepository) FindByIdTelefone(stamp, cpf string) ([]entities.Telefone, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindByIdTelefone", stamp, cpf)
	ret0, _ := ret[0].([]entities.Telefone)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// FindByIdTelefone indicates an expected call of FindByIdTelefone.
func (mr *MockIRepositoryMockRecorder) FindByIdTelefone(stamp, cpf any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindByIdTelefone", reflect.TypeOf((*MockIRepository)(nil).FindByIdTelefone), stamp, cpf)
}
