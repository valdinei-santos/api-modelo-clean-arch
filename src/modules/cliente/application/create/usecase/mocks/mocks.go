...
// Source: src/modules/cliente/usecases/create/interfaces.go
//
...
func (m *MockIRepository) InsertCliente(stamp string, p *dto.Cliente) error {
	m.ctrl.T.Helper()
...
func (m *MockIRepository) InsertTelefone(stamp string, t *dto.Telefone) error {
	m.ctrl.T.Helper()
