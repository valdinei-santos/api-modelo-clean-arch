...
// Source: application/cliente/get02/usecase/interfaces.go
//
...
import (
	...
	usecase "github.com/valdinei-santos/api-modelo-clean-arch/src/application/cliente/get02/usecase"
...
func (m *MockIUsecase) Execute(stamp string) (*usecase.Response, error) {
	m.ctrl.T.Helper()
